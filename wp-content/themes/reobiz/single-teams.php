                ...
                <div class="row btm-row">
                    <div class="col-lg-5">
                        <div class="inner-images">
                            ...
                            <div class="ps-informations">
                                ...
                                <h4 class="single-title"><?php esc_html_e( 'Quick Contact','reobiz' );?></h4>
                                <ul class="personal-info">
                                  ...
                                  <?php if($phone):?>
                                    <li class="phone">
                                      <span><i class="glyph-icon flaticon-phone-call"></i></span> <?php echo esc_html( $phone ); ?>
                                </li>
                              <?php endif; ?>
                    ...
                    <div class="col-lg-7">
                        ...
                        <div class="project-desc">  
                           <h4 class="title-bg-gray padding-top"><?php esc_html_e( 'Experience & Activities','reobiz' );?></h4>              
                            <?php
                                the_content()
                            ?>
                        </div> 
